      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul>
            ...
            <li><Link href="/ourStory">About</Link></li>
        ...
        <div>
          ...
          <ul>
            <li><Link href="/help/payment-options">Payment Options</Link></li>
            <li><Link href="/help/returns">Returns</Link></li>
            <li><Link href="/help/privacy">Privacy Policies</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mb-3">Sign up for our newsletter to get the latest updates.</p>
